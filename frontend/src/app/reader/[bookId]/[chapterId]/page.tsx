...
import { ArrowLeft, Play, BookOpen, Clock, Type, Sparkles, Volume2 } from "lucide-react"
...
export default function ReaderPage() {
  ...
  }, [playerState.isPlaying, playerState.track?.verseNumber, playerState.track?.chapterTitle, playerState.track?.bookTitle, book?.title, chapter?.title])
